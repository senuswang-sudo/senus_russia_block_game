...
### /push-feature
执行 `git push origin feature_version_init` 推送到远端。

### /refactor
对当前文件进行代码风格优化和结构重构，但不改变外部 API。

### /generate-tests
根据当前文件生成 Vitest 单元测试。
